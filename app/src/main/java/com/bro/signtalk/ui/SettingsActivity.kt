...
class SettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // [쌈뽕] 단축번호 설정 버튼 (여기도 나중에 액티비티 만들면 연결해라!)
        findViewById<View>(R.id.btn_speed_dial_settings).setOnClickListener {
            // 아직 목적지가 없으면 토스트라도 띄워주는 게 싹바가지 있는 UI다!
            android.widget.Toast.makeText(this, "단축번호 기능은 준비 중이다 브@로!", android.widget.Toast.LENGTH_SHORT).show()
        }
    }
